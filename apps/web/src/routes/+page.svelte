...
<main class="max-w-3xl mx-auto pt-8 sm:pt-24 px-3 sm:px-4">
  {#if $viewStore.current === 'landing'}
    <div class="text-center mb-8 sm:mb-12">
        <h1 class="font-['Barlow_Condensed'] text-[clamp(2rem,8vw,6rem)] font-black leading-none mb-3 sm:mb-4 tracking-tight">
            LONG VIDEO<br />→ VIRAL SHORTS
        </h1>
        <p class="text-[var(--muted)] text-sm sm:text-base max-w-xl mx-auto px-2">
